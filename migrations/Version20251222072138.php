...
final class Version20251222072138 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, username VARCHAR(100) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, avatar_url VARCHAR(255) DEFAULT NULL, account_status VARCHAR(20) NOT NULL, banned_at DATETIME DEFAULT NULL, warning_count INT DEFAULT 0 NOT NULL, is_email_verified TINYINT(1) NOT NULL, email_verification_token VARCHAR(255) DEFAULT NULL, email_verification_token_expires_at DATETIME DEFAULT NULL, password_reset_token VARCHAR(255) DEFAULT NULL, password_reset_token_expires_at DATETIME DEFAULT NULL, last_login_at DATETIME DEFAULT NULL, remember_me_token VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, displayed_badges JSON NOT NULL, favorite_line_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), INDEX IDX_8D93D649102FDB2C (favorite_line_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE warning (id INT AUTO_INCREMENT NOT NULL, reason LONGTEXT NOT NULL, created_at DATETIME NOT NULL, acknowledged_at DATETIME DEFAULT NULL, related_post_id INT DEFAULT NULL, related_post_type VARCHAR(50) DEFAULT NULL, user_id INT DEFAULT NULL, moderator_id INT DEFAULT NULL, INDEX IDX_404E9CC6A76ED395 (user_id), INDEX IDX_404E9CC6D0AFA354 (moderator_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE line_discussion_reply DROP FOREIGN KEY FK_6C472147F675F31B');
